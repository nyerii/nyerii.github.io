            ...
            <main className='bg-black-100'>
                ...
                <section className='px-4 py-4 border-y border-y-black-400'>
                    <div className='flex flex-wrap gap-2'>
                        <a disabled className='px-4 py-2 border border-black-950 rounded-xl cursor-not-allowed opacity-50' >Puntos de Recogida</a>
                        <a disabled className='px-4 py-2 border border-black-950 rounded-xl cursor-not-allowed opacity-50'>¡Quiero ser voluntario!</a>
                    </div>
                    <p className='mt-2 text-sm text-tall-poppy-700'>*Enlaces no disponibles (Proyecto finalizado)</p>
                </section>
