...
export const TabsSection = () => {
    ...
    return (
        <div className='bg-black-100 px-4 pt-4'>
            <section className='lg:grid grid-cols-2 bg-gray-300 p-4 rounded-xl gap-4'>
                ...
                <div className='bg-gray-300 py-4'>
                    <Tabs value={activeTab}>
                        <TabsHeader className="rounded-none font-inter p-0 border-b border-gray-300 bg-transparent" indicatorProps={{ className: "bg-transparent border-b-2 border-black-950 shadow-none rounded-none", }} >
