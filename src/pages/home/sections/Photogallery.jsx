            ...
            <div className='px-4 mx-auto flex items-center justify-between mt-8 bg-black-950'>
                ...
                <Link to={"/fotogaleria"} className='flex items-center gap-2 text-black-50 group relative opacity-80 hover:opacity-100 transition-all duration-200'>
                    ...
                    <div className='relative'>
                        <svg className='w-4 h-4 text-transparent' width="100%" height="100%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M9 18L15 12L9 6" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
                        <svg className='w-4 h-4 absolute left-0 top-0 group-hover:translate-x-[5px] transition-all duration-200' width="100%" height="100%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M9 18L15 12L9 6" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
                    </div>
                </Link>
            </div>
